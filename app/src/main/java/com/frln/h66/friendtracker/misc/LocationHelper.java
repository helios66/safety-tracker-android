...
/**
 * @author fdamilola on 03/02/2017.
...
public class LocationHelper {
    ...
    public void displayLocationSettingsRequest(final Context context) {
        ...
        final int LOCATION_REQUEST_CHECK_SETTINGS = 434;
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            // in onActivityResult().
                            status.startResolutionForResult((MainActivity)context, LOCATION_REQUEST_CHECK_SETTINGS);
